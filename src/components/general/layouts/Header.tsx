        ...
        >
          <ul className={`flex flex-col lg:flex-row`}>
            {navLinks.map((data) => (
              <li
                key={data.id}
                className="lg:mx-0 xl:mx-8 text-xl md:my-8 sm:my-0 my-7 font-semibold font-sans"
              >
          ...
          <div className="flex gap-5 lg:hidden">
            <Button className="bg-primary font-semibold text-white px-8 leading-7 text-base">
              Get Started
            </Button>
            <Button className="border-stroke-500 border text-base">
              <div className="flex">
                <svg
