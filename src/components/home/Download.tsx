    ...
    <div className="bg-secondary-700 bg-mobile-download sm:bg-download-bg bg-no-repeat bg-contain -mt-[24rem] sm:-mt-[20.6rem] lg:-mt-[30rem] 2xl:-mt-[32rem] relative pb-[3.8rem] sm:pb-16 xl:pb-40 2xl:pb-64">
      <div className="container px-5 sm:px-10 pb-8 2xl:px-0 mx-auto pt-10 sm:pt-10 lg:pt-36 xl:pt-40 2xl:pt-80">
        <div className="text-center flex flex-col gap-5 sm:gap-2 xl:gap-5">
          ...
          <p className="text-xl font-medium text-[#A9C5DE] hidden sm:block">
            The best care for you – anywhere, anytime.
          </p>
          <div className="flex flex-row mt-1 sm:mt-5 gap-5 mx-auto">
            <Button className="bg-white hover:bg-secondary-900 transition-colors font-semibold text-primary w-36 sm:w-44 lg:w-52 py-2 sm:py-3 leading-7 text-sm sm:text-base rounded-full">
            ...
            <Button className="bg-primary hover:bg-secondary-900 transition-colors font-semibold text-white w-[9.8rem] sm:w-44 lg:w-52 py-2 sm:py-3 leading-7 text-sm sm:text-base rounded-full">
